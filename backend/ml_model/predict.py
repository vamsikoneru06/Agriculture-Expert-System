...
def _estimate_confidence(yield_val: float, crop: str) -> int:
    ...
    typical_ranges = {
        ...
        "moong":        (0.8, 1.5),
        "jute":         (2.0, 3.5),
        "watermelon":   (22.0, 42.0),
        "cucumber":     (14.0, 28.0),
        "muskmelon":    (14.0, 27.0),
        "okra":         (8.0, 16.0),
        "bitter_gourd": (7.0, 15.0),
        "bottle_gourd": (20.0, 40.0),
        "cowpea":       (0.8, 1.8),
        "sesame":       (0.6, 1.2),
        "oats":         (2.0, 4.2),
        "pumpkin":      (20.0, 42.0),
...
def _grade_yield(yield_val: float, crop: str) -> tuple[str, str]:
    ...
    typical_hi = {
        ...
        "chickpea": 2.0,   "barley": 4.5,     "mustard": 2.2,
        "lentil": 1.7,     "bajra": 3.0,      "sorghum": 4.0,
        "moong": 1.5,      "jute": 3.5,       "watermelon": 42.0,
        "cucumber": 28.0,  "muskmelon": 27.0, "okra": 16.0,
        "bitter_gourd": 15.0, "bottle_gourd": 40.0, "cowpea": 1.8,
        "sesame": 1.2,     "oats": 4.2,       "pumpkin": 42.0,
        "taro": 34.0,
    }
